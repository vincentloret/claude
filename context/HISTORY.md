...
- Profil principal : salarié en ESN, UX designer senior (25+ ans d'expérience)
- Activité : UX designer senior chez Conserto, actuellement en mission sur les projets ADEME et FEDEA (recherche utilisateur, wireframing, animation d'ateliers)
- Objectifs court terme identifiés : décrocher une mission stratégique chez un grand compte, monter en compétence sur un outil ou une méthode précise, changer d'employeur
- Vision long terme : rejoindre une structure alignée avec ses valeurs, développer une expertise reconnue à l'intersection UX et IA, viser un rôle de Lead ou Head of Design
- Projets actifs au démarrage : changement d'employeur, montée en compétence en cours
